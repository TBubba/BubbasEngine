...
namespace BubbasEngine.Engine.Graphics
{
    ...
    /// 2D rendering
    /// </summary>
    internal class RenderWindow : Window, IRenderTarget
    {
        /// <summary>
        ...
        protected override bool PollEvent(out SFMLEvent eventToFill)
        {
        ...
        protected override bool WaitEvent(out SFMLEvent eventToFill)
        {
        ...
        [DllImport("csfml-graphics-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern bool sfRenderWindow_pollEvent(IntPtr CPointer, out SFMLEvent Evt);
            
        [DllImport("csfml-graphics-2", CallingConvention = CallingConvention.Cdecl), SuppressUnmanagedCodeSecurity]
        static extern bool sfRenderWindow_waitEvent(IntPtr CPointer, out SFMLEvent Evt);
